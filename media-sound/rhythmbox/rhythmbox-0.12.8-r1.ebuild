...
EAPI=3
inherit gnome2 multilib virtualx eutils
...
KEYWORDS="~amd64 ~x86"
IUSE="+brasero cdr daap doc gnome-keyring ipod libnotify lirc musicbrainz mtp nsplugin python test udev upnp webkit"
SLOT="0"
