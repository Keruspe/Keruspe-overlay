...
src_prepare() {
	epatch ${FILESDIR}/0001-Add-state-for-flushing-the-handshake-buffer.patch
	epatch ${FILESDIR}/0002-Check-whether-the-error-is-fatal-in-more-cases.patch
	epatch ${FILESDIR}/0003-Remember-the-amount-of-user-data-we-re-sending-out.patch
